...
namespace CSknowledgePro
{
    ...
    public abstract class aAddStudent
    {
        public abstract void AddStudents();
        public abstract void AddDetails();
    }

    public class AddStudent : aAddStudent
    {
    ...
    public abstract class aInputMarks
    {
        public abstract AddStudent GetMarks();
    }

    public class InputMarks : aInputMarks
    {
    ...
    public abstract class aDisplayDetails
    {
        public abstract void ViewRecords();
    }

    public class DisplayDetails : aDisplayDetails
    {
